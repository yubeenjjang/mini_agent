"""외부 API 없이 일반·구조화 생성을 재현하는 교육용 Mock Provider입니다."""
...
class MockProvider:
    ...
    def generate_structured(self, system_prompt: str, message: str) -> ProviderResult:
        ...
        return ProviderResult(self.name, self.model, plan.model_dump(), 0)
    def select_tool(self, message: str, tools: list[dict[str, Any]]) -> ProviderToolCall:
        raise NotImplementedError("Mock Tool 선택은 agents.tool_selector가 담당합니다.")
